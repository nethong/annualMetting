    ...
    var defaults = {
        awards: 'third',
        prize:{
            'grateful':{ 'nub':0 ,'prize_name':'空气净化器', 'prize_img':'img/iphone6.jpeg'},
    ...
    $.fn.lottery = function(options){
        ...
        var config = {
            ...
            'keycode': {
                '49': { 'class': 'first',   'name': '特等奖', 'total': settings.prize.grateful.nub },
                '50': { 'class': 'second',  'name': '一等奖', 'total': settings.prize.second.nub },
                '51': { 'class': 'third',   'name': '二等奖', 'total': settings.prize.third.nub },
                '52': { 'class': 'grateful','name': '三等奖', 'total': settings.prize.first.nub },
            ...
            $('#content').append(
                    '<div id="js_btn">'+
                        ...
                        '<div class="circle_btn prize prize3" data-key=51 >'+
                            '<div class="btn_name" >二等奖</div>'+
                        '</div>'+
                        '<div class="circle_btn prize prize4" data-key=52 >'+
                            '<div class="btn_name">三等奖</div>'+
                        '</div>'+
                        '<div class="circle_btn stop" >'+
                            '<div class="btn_name">停止</div>'+
        ...
        el.default_result = function(){
            ...
            if(config.awards == 'third'){
                ...
                prize = [settings.prize['grateful'].prize_name,settings.prize['grateful'].prize_img,'特等奖'];
            }else{}
